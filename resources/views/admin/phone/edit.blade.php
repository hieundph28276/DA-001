...
<div class="card-box">
    <div class="">
        <div>
            ...
            <form action="{{ route('route_phone_edit', ['id'=>$phone->id]) }}" class="parsley-examples" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="userName">Tên sản phẩm<span class="text-danger">*</span></label>
                    <input type="name" name="name" value="{{$phone->name}}" placeholder="Enter user name" class="form-control" id="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="" type="price" name="price" value="{{$phone->price}}" placeholder="" class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Mô tả sản phẩm<span class="text-danger">*</span></label>
                    <input type="description" name="description" value="{{$phone->description}}" placeholder="description" class="form-control" id="">
                </div>
                <div class="form-group">
